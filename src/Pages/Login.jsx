...
function Login() {
  ...
  return (
    ...
    <div className="hidden bg-cover lg:block lg:w-1/2" ><img src={login} alt="" /></div>
...
<div className="mt-4">
        ...
        <div className="flex items-center justify-between mt-4">
           ...
           <Link to={'/register'}> <a href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a></Link>
