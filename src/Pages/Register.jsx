...
function Register() {
    const {Signup,  signInWithGoogle, updateUserProfile, user, setUser} = useContext(AuthContext)
  ...
  return (
    ...
    <div className="hidden bg-cover lg:block lg:w-1/2 lg:pt-20" ><img src={login} alt="" /></div>

    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        <div className="flex justify-center mx-auto">
            <img src="https://merakiui.com/images/logo.svg" alt="" className="w-auto h-7 sm:h-8" />
        </div>
        ...
        <a href="#" onClick={handleSignWithGoogle} className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
     ...
     <div className="mt-4">
            ...
            <input name='name' className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300" type="text" />
        </div>
     <div className="mt-4">
        ...
        <div className="mt-4">
            ...
            <input name='photo' className="block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300" type="url" />
        </div>
        <div className="mt-6">
        ...
        <div className="flex items-center justify-between mt-4">
            ...
            <Link to={'/login'}><a href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or Login</a></Link>
